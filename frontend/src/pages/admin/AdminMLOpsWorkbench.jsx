    ...
    <div className="space-y-6 relative h-full">
      ...
      <div className="bg-white border border-[#A1887F]/20 rounded-xl p-5 shadow-sm flex items-center justify-between">
        ...
        <button
          ...
          onClick={() => alert(`Export requested for ${selected.length} flagged sample(s).`)}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 pb-20">
        {loading ? (
          <div className="col-span-full py-20 text-center">
            <p className="text-gray-500 font-medium">Loading flagged classifications…</p>
          </div>
        ) : items.length === 0 ? (
          <div className="col-span-full py-20 text-center">
            <p className="text-gray-500 font-medium">No flagged classifications to review.</p>
          </div>
        ) : (
          items.map((err) => {
            ...
            return (
              ...
              >
                ...
                <div className="w-full h-40 bg-[#FAF0E6]/50 flex items-center justify-center">
                  {err.url ? (
                    <img src={err.url} alt="Flagged Bean" className="w-full h-40 object-cover" />
                  ) : (
